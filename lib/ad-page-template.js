        ...
        <aside id="consultation" class="ad-consult-panel market-consult-panel">
          ...
          <form class="ad-form-card ad-form-card-v2 contact-intake"
            ...
            <label class="consent-row">
              ...
              <span>By checking this box, I agree to receive recurring promotional and informational text messages from Lorenzo's Dog Training Team about dog training, consultation scheduling, follow-up, and offers. Messages may be sent via autodialer. Consent is not a condition of any purchase or services. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe and HELP for help. I also agree to the <a href="${asset("terms.html")}">Terms of Service</a> and <a href="${asset("privacy-policy.html")}">Privacy Policy</a>.</span>
            </label>
