...
function css() {
  ...
  .lp-price-from{display:block;font-size:15px;font-weight:600;color:var(--muted);margin-bottom:2px}
        ...
        <form class="contact-intake lp-form"
          ...
          <div class="lp-step" data-lp-step="3" hidden>
            ...
            <label class="lp-consent">
              ...
              <span>By checking this box, I agree to receive text messages from Lorenzo's Dog Training Team about my request: follow-up on my inquiry, scheduling and confirming my free consultation or evaluation, and appointment reminders. Messages may be sent via autodialer. Consent is not a condition of any purchase or services. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe and HELP for help. I also agree to the <a href="terms.html">Terms of Service</a> and <a href="privacy-policy.html">Privacy Policy</a>.</span>
            </label>
    ...
    <div class="lp-wrap lp-price">
      ...
      <div class="lp-price-row">
        <div class="lp-price-block">
          ...
          <span class="lp-price-from">Starting at</span>
          <span class="lp-price-big"><sup>$</sup>1,250</span>
          <span class="lp-price-sub">obedience, behavior &amp; puppy programs</span>
        </div>
        <div class="lp-price-block">
          <span class="lp-price-label">Board &amp; train</span>
          <span class="lp-price-from">Starting at</span>
          <span class="lp-price-big"><sup>$</sup>2,500</span>
          <span class="lp-price-sub">your dog lives and learns on campus</span>
        </div>
      </div>
    </div>
  </section>
