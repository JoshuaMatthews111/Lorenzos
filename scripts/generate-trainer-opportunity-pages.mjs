      ...
      <div class="container ad-hero-v2-grid">
        ...
        <aside id="trainer-interest" class="ad-consult-panel">
          ...
          <form class="ad-form-card-v2 trainer-application-form"
            ...
            <small class="form-callback-disclosure">Phone is required so Lorenzo's recruiting team can call about your request. SMS consent below is optional and separate.</small>
