...
<head>
  ...
  <style>
    ...
    /* ═══ pricing that actually lands ═══ */
    .market-pricing{padding:58px 0 40px}
    .price-kicker{margin:0;font-size:15px;letter-spacing:.08em;text-transform:uppercase;color:#6b7186;font-weight:700}
    .price-punch{margin:2px 0 26px;font-size:clamp(34px,5vw,54px);font-weight:900;letter-spacing:-.02em;color:var(--mk1)}
    .price-cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px}
    .price-card{position:relative;background:#fff;border:2px solid var(--mk1);padding:26px 24px 22px;overflow:hidden}
    .price-card::before{content:"";position:absolute;top:0;left:0;right:0;height:6px;background:var(--mk1)}
    .price-card-alt{background:var(--mk1)}
    .price-card-alt .price-label,.price-card-alt .price-big,.price-card-alt .price-sub{color:#fff}
    .price-label{display:block;font-size:12px;font-weight:800;letter-spacing:.16em;text-transform:uppercase;color:var(--mk1)}
    .price-big{display:block;font-size:clamp(46px,7vw,68px);font-weight:900;letter-spacing:-.03em;line-height:1.05;color:#141826}
    .price-sub{display:block;font-size:13px;color:#5c6275;margin-top:2px}
    .guarantee-band{display:flex;align-items:center;gap:22px;flex-wrap:wrap;margin-top:22px;
      background:linear-gradient(120deg,var(--mk1),#20264a);padding:24px 26px;color:#fff}
    .guarantee-band p{margin:0;color:#e8eaf6;font-size:15px;line-height:1.55;flex:1;min-width:260px}
    .guarantee-band h2{margin:0 0 8px;color:#fff;font-size:clamp(22px,3.4vw,30px);font-weight:900}
    .guarantee-lead{align-items:flex-start;padding:30px 28px}
    .price-quiet-line{margin-top:12px !important;font-size:13.5px !important;color:#c7cdea !important}
    .g-badge{flex:none;display:inline-block;background:#fff;color:var(--mk1);font-weight:900;font-size:15px;
      line-height:1.15;text-align:center;padding:16px 14px;border-radius:50%;width:96px;height:96px;
  ...
  <main>
    ...
    <section class="section market-pricing price-forward">
      <div class="container">
        ...
        <h2 class="price-punch">We'll just tell you.</h2>
        <div class="price-cards">
          <div class="price-card">
            <span class="price-label">Professional Training</span>
            <span class="price-big">$1,250</span>
            <span class="price-sub">starting at &middot; obedience, behavior &amp; puppy programs</span>
          </div>
          <div class="price-card price-card-alt">
            <span class="price-label">Training + Boarding</span>
            <span class="price-big">$2,500</span>
            <span class="price-sub">starting at &middot; your dog trains with a pro, comes home transformed</span>
          </div>
        </div>
        <div class="guarantee-band">
          <span class="g-badge">90-DAY<br>GUARANTEE</span>
          <p><b>If it isn't working, we come back — free.</b> Every program is covered for 90 days after training completes: do your part, and if your dog isn't showing the trained behaviors, corrective training costs you nothing.</p>
          <a class="btn btn-red price-cta" href="#consultation">Get My Free Evaluation &rarr;</a>
        </div>
      </div>
    </section>` : `
    <section class="section market-pricing price-quiet">
      <div class="container">
        <div class="guarantee-band guarantee-lead">
          <span class="g-badge">90-DAY<br>GUARANTEE</span>
          <div>
            <h2>We put it in writing. Most trainers won't.</h2>
            <p><b>The LDTT Training Guarantee:</b> if your dog isn't demonstrating the trained behaviors within 90 days of completing training — and you've done your part — we provide corrective training at <b>no additional fee</b>. Your investment is protected for the next ten years of life with your dog.</p>
            <p class="price-quiet-line">Programs begin at $1,250 &middot; training with boarding from $2,500 &middot; exact quote at your <b>free evaluation</b></p>
          </div>
          <a class="btn btn-red price-cta" href="#consultation">Get My Free Evaluation &rarr;</a>
        </div>
      </div>
